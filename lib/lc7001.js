...
class LC7001 {
    constructor(platform, password = '', tcpOptions, delimiter = '\0', tcpTimeoutSeconds = 30, tcpRetrySeconds = 30) {
        ...
        var passwordHasher = crypto_1.default.createHash('MD5');
    ...
    answerChallenge(challenge) {
        var answer;
        var answerCipher = crypto_1.default.createCipheriv('AES-128-ECB', this.passwordHash, null);
